...
struct SessionButton: View {
    ...
    var body: some View {
        ...
        .claimsMouseDown()
        // Written the way the menu item draws it. It was ⌘⇧K here and bound to
        // nothing at all until the View menu's "Change Session" landed, then
        // ⇧⌘K until that item moved to the unshifted chord.
