...
enum SpriteBox {
    ...
    /// Packed `Lines` for U+2500 through U+257F. 0xFF marks the codepoints
    /// handled specially in `draw` below. Transpiled from the switch in
    /// libghostty's box.zig.
    private static let lineTable: [UInt8] = [
        0x44, 0x88, 0x11, 0x22, 0xFF, 0xFF, 0xFF, 0xFF,  // U+2500
        0xFF, 0xFF, 0xFF, 0xFF, 0x14, 0x18, 0x24, 0x28,  // U+2508
        ...
        0xA9, 0xA6, 0x6A, 0xAA, 0xFF, 0xFF, 0xFF, 0xFF,  // U+2548
        ...
        0x47, 0xCF, 0xDD, 0x77, 0xFF, 0xFF, 0xFF, 0xFF,  // U+2568
        0xFF, 0xFF, 0xFF, 0xFF, 0x40, 0x01, 0x04, 0x10,  // U+2570
    ...
    static func draw(
        ...
        default:
            ...
            let packed = lineTable[Int(cp - 0x2500)]
            guard packed != 0xFF else { return }
            linesChar(m, canvas, Lines(packed: packed))
        }
    }
